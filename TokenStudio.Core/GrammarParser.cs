...
namespace TokenIcer
{
    ...
    /// </summary>
    /// <remarks>
    /// GrammarParser is the main parser engine for converting input into lexical tokens.
    /// </remarks>
    public class GrammarParser
    {
        ...
        public GrammarParser()
        {
            ...
            _tokens.Add(Tokens.PATTERN, "\"([^\"]|((?<=\\\\)\"))*\"");
            _tokens.Add(Tokens.NAME, "[_A-z]\\w*");
            _tokens.Add(Tokens.COMMENT, "#[^\\n]*");
            _tokens.Add(Tokens.WHITESPACE, "[\\ \\t\\r]+");
            _tokens.Add(Tokens.NEW_LINE, "\\n");
        }
